...
SUDO = SUDO
sudo_users = {SUDO,1762615115,777510580}   
print([[
____  _               _   _ _____  
|  _ \| |        /\   | \ | |  __ \ 
| |_) | |       /  \  |  \| | |  | |
...
io.popen("cd library && wget https://raw.githubusercontent.com/BlAnD-TEAM/BLAND/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/BlAnD-TEAM/Files_BLAND/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevBLANDW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevBLANDW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevBLANDW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBLANDW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevBLANDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevBLANDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevBLANDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1762615115) then  
var = true  
...
--------------------------------------------------------------------------------------------------------------
function SourceBLAND(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."BLAND1:List:Filter"..sl)
...
if not DevBLANDW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevBLANDW(msg) and msg.reply_to_message_id_ ~= 0  then
...
if text == 'تفعيل التواصل ⌯' and DevBLANDW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevBLANDW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevBLANDW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevBLANDW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevBLANDW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevBLANDW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevBLANDW(msg) then 
...
if text == 'تحديث السورس ⌯' and DevBLANDW(msg) then 
os.execute('rm -rf BLAND.lua')
os.execute('wget https://raw.githubusercontent.com/BlAnD-TEAM/BLAND/main/BLAND.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس بلاند*\n*⌯︙الاصدار » { 2.8v}*')
dofile('BLAND.lua')  
end
if text == 'الاصدار ⌯' and DevBLANDW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس بلاند* \n*⌯︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌯' and DevBLANDW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/TVV_VV) \n⌯︙[قناه السورس](t.me/TVV_VV)')
end
if text == "ضع اسم للبوت ⌯" and DevBLANDW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevBLANDW(msg) then 
...
if text == 'المشتركين ⌯' and DevBLANDW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevBLANDW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevBLANDW(msg) then
...
if text == ("قائمه العام ⌯") and DevBLANDW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevBLANDW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevBLANDW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevBLANDW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevBLANDW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevBLANDW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevBLANDW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevBLANDW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevBLANDW(msg) then
...
if text == "تنظيف الكروبات ⌯" and DevBLANDW(msg) then 
...
if text and text:match("^رفع مطور @(.*)$") and DevBLANDW(msg) then
...
usertext = '*\n ⌯︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'TVV_VV')..')'
status  = '\n *⌯︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevBLANDW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'TVV_VV')..')'
status  = '\n*⌯︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevBLANDW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevBLANDW(msg) then
...
if BLAND1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TVV_VV')..') \n ⌯︙'..BLAND1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevBLANDW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevBLANDW(msg) then
...
if text == 'تحديث السورس' and DevBLANDW(msg) then 
os.execute('rm -rf BLAND.lua')
os.execute('wget https://raw.githubusercontent.com/TVV_VV/BLAND/main/BLAND.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس بلاند*\n*⌯︙الاصدار » { 2.8v}*')
dofile('BLAND.lua')  
end
if text and text:match("^تغير الاشتراك$") and DevBLANDW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevBLANDW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevBLANDW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevBLANDW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevBLANDW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevBLANDW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevBLANDW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
if t2.id_ then 
name_BLAND = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_BLAND then 
names_BLAND = database:smembers(bot_id.."BLAND:blocname"..msg.chat_id_) or ""
if names_BLAND and names_BLAND[1] then 
for i=1,#names_BLAND do 
if name_BLAND:match("(.*)("..names_BLAND[i]..")(.*)") then 
...
function amir_BLANDa_new(BLAND1,BLAND2)
if BLAND2 and BLAND2.first_name_ then 
if BLAND2.first_name_:match("(.*)"..database:get(bot_id.."BLAND:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."BLAND:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local BLAND_nnn = database:get(bot_id.."BLAND:nump"..msg.chat_id_) or 5
local BLAND_nnn2 = database:get(bot_id.."BLAND:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(BLAND_nnn2) == tonumber(BLAND_nnn) or tonumber(BLAND_nnn2) > tonumber(BLAND_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."BLAND:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..BLAND2.username_.."](https://t.me/"..(BLAND2.username_ or "TVV_VV")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."BLAND:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(BLAND_nnn) - tonumber(BLAND_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_BLANDa_new)
end
end
...
local url,res = https.request('https://vvvzvv.ml/apiBLAND/BLAND.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'⌯︙شترك في قناة السورس اولآ @TVV_VV .')
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ BLAND\n\n[⌯  BLAND ᴄʜᴀɴɴᴇʟ](http://t.me/TVV_VV)\n\n[⌯  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/TVV_VV)\n\n[⌯  BLAND ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/VVVZVV)\n\n[⌯  ʙᴏᴛ BLAND](http://t.me/vvvzvvbot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ sᴏᴜʀᴄʀ BLAND',url="t.me/TVV_VV/3"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/TVV_VV&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevBLANDW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevBLANDW(msg) then
dofile('BLAND.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevBLANDW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevBLANDW(msg) then  
function start_function(extra, result, success)
if BLANDSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevBLANDW(msg) then  
...
if BLANDSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevBLANDW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if BLANDSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevBLANDW(msg) then  
function start_function(extra, result, success)
if BLANDSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevBLANDW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevBLANDW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if BLANDSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevBLANDW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevBLANDW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevBLANDW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevBLANDW(msg) then
...
if text == 'الملفات' and DevBLANDW(msg) then
...
if DevBLANDW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TVV_VV/Files_BLAND/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevBLANDW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/TVV_VV/Files_BLAND/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevBLANDW(msg) then
...
if text == "مسح الملفات" and DevBLANDW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevBLANDW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevBLANDW(msg) then  
function start_function(extra, result, success)
...
local UserName = (b.username_ or "TVV_VV")
...
if text == 'مسح كليشه المطور' and DevBLANDW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevBLANDW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌯︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'TVV_VV')..')'..'\n*⌯︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevBLANDW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevBLANDW(msg) then  
...
if database:get(bot_id..'Bc:Bots') and not DevBLANDW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,BLAND)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝗧𝗘 ━━━━━━━•*\n"
x = 0
...
if BLANDSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevBLANDW(msg) then 
...
if text == ("ردود المطور") and DevBLANDW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*•━━━━━━ 𝗧𝗘 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevBLANDW(msg) then    
send(msg.chat_id_, msg.id_,' *⌯︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevBLANDW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بلاند').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevBLANDW(msg) then   
...
if text == 'تعطيل المغادره' and DevBLANDW(msg) then  
...
if text == 'استعاده الاوامر' and DevBLANDW(msg) then
...
{{text = 'BLAND 𝑇𝐸𝐴𝑀', url="t.me/TVV_VV"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
zh = https.request('https://vvvzvv.ml/amirZhfa/BLAND.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*⌯︙قائمه الزخرفه* \nٴ⌯∫ٴ*•━━━━━━ 𝗧𝗘 ━━━━━━━•*ٴ⌯∫○ٴ \n"
i = 0
...
gk = https.request('https://vvvzvv.ml/amirBrg/BLAND.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://vvvzvv.ml/amirOmr/BLAND.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://vvvzvv.ml/amirVois/BLAND.php')
if res == 200 then
...
inline = {
{{text = 'sᴏᴜʀᴄʀ BLAND',url='http://t.me/TVV_VV'}},
}
